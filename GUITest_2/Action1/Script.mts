...
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("quantity").Set DataTable("Qunatity", dtGlobalSheet)
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("itemCount").Click
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("ITEMS (0)").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("ITEMS (0)")_;_script infofile_;_ZIP::ssf7.xml_;_
